...
if __name__ == '__main__':
    ...
    for f in files:
        ...
        rgb_img = toStdInputCv(args.image_path)[:, :, ::-1]
        ...
        for target_category in [None,]:
            ...
            cv2.imwrite(f'{f}_{target_category}_cam.jpg', cam_image)
            # cv2.imwrite(f'{f}_{target_category}gb.jpg', gb)
            # cv2.imwrite(f'{f}_{target_category}cam_gb.jpg', cam_gb)
